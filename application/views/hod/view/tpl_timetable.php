 ...
 <div class="container">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("hod/users/add_t_event"), array("class" => "form-horizontal")) ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <?php echo form_open(site_url("hod/users/edit_t_event"), array("class" => "form-horizontal")) ?>
      <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Event Name</label>
                <div class="col-md-8 ui-front">
    ...
    $('#calendar').fullCalendar({
        eventSources: [
           ...
           events: function(start, end, timezone, callback) {
                $.ajax({
                    url: '<?php echo base_url() ?>hod/users/get_t_events',
                    dataType: 'json',
                    data: {
