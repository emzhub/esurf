              ...
              //  foreach ($row2->children as $row) :?>
                  <tr>                    
                    ...
                    <td class="mailbox-name">
                      ...
                      <!--   <a href="#read_hod_mail" data-toggle="modal" class="read_hod_message" data-id="<?php// echo $row->message_id; ?>"> -->
                            <strong>
                      ...
                      <td class="mailbox-name">
                            <!--  <a href="<?php //echo site_url('hod/users/readmessage').'/'.$row->user_from;?>"> -->
                       <!--  <a href="#read_hod_mail" data-toggle="modal" class="read_admin_message" data-id="<?php echo $row->message_id; ?>"> -->
                            <strong>
                            <?php if($status=='read') echo '</strong><del>'; ?>
