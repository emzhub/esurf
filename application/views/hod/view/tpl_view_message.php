                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                  ...
                                  <p class="pull-left">
                                   <a href="<?php echo site_url('hod/users/compose');?>" class="btn btn-danger btn-block btn-sm"><span class="fa fa-edit"></span>COMPOSE NEW MESSAGE</a>     </p>             
        ...
        <!--       </form>  -->         
                ...
                <div class="error-page">
                    ...
                    <div class="error-content">
                      ...
                      <form class="search-form" method="POST" action="<?php echo base_url(); ?>hod/users/search">
...
<?php $this->load->view('hod/modal/read'); ?>
<?php $this->load->view('hod/modal/search'); ?>
<?php $this->load->view('hod/script/message'); ?>
