...
<div class="span9">
	...
	<div class="row">
			...
			<div id="gallery" class="span3">
                               <?php foreach ($avatar as $menu) { ?>
                              <?php foreach ($item as $child) { ?>
                                        <a  href="<?= base_url('public/client/view/'.$menu->category_id.'/'.$menu->sector_id.'/'. $child->post_id.'')   ?>">
			<img src="<?= base_url('files/product/'.$menu->category_id.'/'.$menu->sector_id.'/'. $child->post_id.'.png')   ?>" alt=""/>
            </a>
                              <?php	  }  }
            ?>
			</div>
