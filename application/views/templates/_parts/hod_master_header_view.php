...
<body>
<?php
if($this->ion_auth->logged_in() && $this->ion_auth->is_hod()) {
?>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
               ...
               <ul class="x-navigation">
                    <li class="xn-log">
                        <a href="<?php echo site_url('hod');?>"><?php echo APP_NAME;?> ||  <?php 
...
// }  
            ?>
                    ...
                    <li class="active">
                        <a href="<?php echo site_url('hod');?>"><span class="fa fa-desktop"></span> <span class="xn-text">Home</span></a>                        
                    </li>                    
    ...
    <?php
            ...
            ?>
                                    <span class="contacts-title">
                                           <a href="<?php echo site_url('hod/users/readmessage').'/'.$row->user_from;?>">
                ...
                <?php endforeach; ?>
                  <?php endif; ?>  
                            ...
                            <div class="panel-footer text-center">
                                <a href="<?php echo site_url('hod/users/message')?>">Show all messages</a>
                            </div>                            
                        </div>                        
                    </li>
...
-->
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?php echo site_url('hod');?>">Home</a></li>                    
