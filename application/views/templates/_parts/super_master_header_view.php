        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
               ...
               <ul class="x-navigation">
                    <li class="xn-log">
                        <a href="<?php echo site_url('super');?>"><?php echo APP_NAME;?></a>
...
// }  
            ?>
                    ...
                    <li class="active">
                        <a href="<?php echo site_url('super');?>"><span class="fa fa-desktop"></span> <span class="xn-text">Home</span></a>                        
                    </li>                    
...
-->
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?php echo site_url('super');?>">Home</a></li>                    
